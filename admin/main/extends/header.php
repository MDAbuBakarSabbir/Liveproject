        ...
        <div class="app-sidebar">
            <div class="logo">
                <a href="index.php" class="logo-icon">
                    <img class="logo-text" src="./assets/images/SAVALON.png" alt="">
                    <span class="logo-text">SABALON</span>
                </a>
                <div class="sidebar-user-switcher user-activity-online">
                    <a href="index.php">
                        <?php if ($user['image'] == 'default.png') { ?>
                        <img src="assets\images\default/<?= $user['image'] ?>">
                        <?php }else{  ?>
                        <img src="assets\images\profile/<?= $user['image'] ?>">
                        <?php } ?>
            ...
            <div class="app-menu">
                <ul class="accordion-menu">
                    ...
                    <li class="<?= ($link == 'profile.php' || $link == 'settings.php' || $link == 'register.php') ? 'active-page' : '' ?>">
                        <a href=""><i class="material-icons-two-tone">person</i>Account<i class="material-icons has-sub-menu">keyboard_arrow_right</i></a>
                        <ul class="sub-menu">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li>
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <li>
                                        <a href="../Auth/sign-up.php">Sign Up</a>
                                    </li>
                                    <li>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-flex">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item hidden-on-mobile">
                                    <a class="nav-link bg-danger text-white" href="main/extends/logout.php">Logout</a>
                                </li>
                            </ul>
                        </div>
                    </div>
